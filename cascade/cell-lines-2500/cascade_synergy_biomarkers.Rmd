...
rmarkdown::render(input = "cascade_synergy_biomarkers.Rmd", output_dir = "../../docs/cascade/cell-lines-2500/")
```
...
<div class="blue-box">
The `PTEN` node is found highly expressed in the `A498` cell line, but for the models to predict the `PD-PI` synergy we found that the node needs to be in an **inhibited state** ([see here](#Text1)). The overexpression of the `ERK_f` node is also a result from this analysis.
</div>
</br>
