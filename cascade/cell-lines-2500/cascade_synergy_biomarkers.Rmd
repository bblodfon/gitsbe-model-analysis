...
threshold = 0.8
biomarker.state.mat = binarize.to.thres(mat = diff.state.mat, threshold)
...
biomarker.link.mat = binarize.to.thres(mat = diff.link.mat, thres = 0.8)
...
biomarker.state.mat.random = binarize.to.thres(mat = diff.state.mat.random, thres = 0.7)
...
biomarker.link.mat.random = binarize.to.thres(mat = diff.link.mat.random, thres = 0.7)
...
ak.pd.biomarker.state.mat = binarize.to.thres(mat = ak.pd.diff.state.mat, thres = 0.7)
ak.pd.biomarker.link.mat  = binarize.to.thres(mat = ak.pd.diff.link.mat, thres = 0.7)
