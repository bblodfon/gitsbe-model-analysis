...
More specifically, we wil investigate the two synergies: `AK-PD`, `PD-PI` and try to find causal mechanisms that might explain why and where (pathways) these synergies manifest. 
...
```{r Data processing}
activity.biomarkers.cell.specific = list()
for (cell.line in cell.lines) {
  activity.biomarkers.cell.specific[[cell.line]] = 
    cell.specific.synergy.analysis.res[[cell.line]]$activity.biomarkers
}

activity.biomarkers.random = list()
for (cell.line in cell.lines) {
  activity.biomarkers.random[[cell.line]] = 
    random.synergy.analysis.res[[cell.line]]$activity.biomarkers
}

activity.biomarkers.cell.specific.res = ldf_arrange_by_rownames(activity.biomarkers.cell.specific)
activity.biomarkers.random.res = ldf_arrange_by_rownames(activity.biomarkers.random)
```
